...
/**
 * Adapted from auto-form at this commit:
 *
 * https://github.com/vantezzen/auto-form/blob/e02d0de88b19a2edb60cfac2e27b72e15739eb5a/src/components/ui/auto-form.tsx
 */

import { zodResolver } from '@hookform/resolvers/zod';
import { formStaticClass, type StyleProps } from '@supastack/ui-styles';
...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '../Accordion/index.ts';
import { Box } from '../Box/index.ts';
// import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
// import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from './accordion';
import { Button } from '../Button/index.ts';
import { Input } from '../Input/index.ts';
import { useForm as useFormStyles } from './context.tsx';
...
function AutoFormInput({ label, isRequired, fieldConfigItem, fieldProps }: AutoFormInputComponentProps) {
  const { slots, slotClasses } = useFormStyles();
...
function AutoFormObject<SchemaType extends z.ZodObject<any, any>>({
  ...
  const nestedContainerTw = slots.nestedContainer({
    class: [formStaticClass('nestedContainer'), slotClasses?.nestedContainer],
  });

  return (
    <Accordion type="multiple" tw={nestedContainerTw}>
      {Object.keys(shape).map(name => {
        ...
        if (zodBaseType === 'ZodArray') {
          return <div key={key}>Array not implemented</div>;
          // return (
          //   <AutoFormArray
          //     key={key}
          //     name={name}
...
export function AutoForm<SchemaType extends ZodObjectOrWrapped>({
  ...
  const defaultValues: DefaultValues<z.infer<typeof objectFormSchema>> =
    defaultValuesProp !== undefined ? defaultValuesProp : getDefaultValues(objectFormSchema);
