...
export const headingStyle = tv(
  {
    ...
    variants: {
      size: {
        ...
        5: tx('text-2xl font-medium leading-5'),
        6: tx('text-3xl font-semibold leading-6'),
        7: tx('text-4xl font-semibold leading-7'),
        8: tx('text-5xl font-bold leading-8'),
        9: tx('text-7xl font-bold leading-9'),
      },
      trim: {
